...
flyTab:AddButton("Fly Up (Hold)", function() end) -- Ð”Ð»Ñ ÑƒÐ´Ð¾Ð±ÑÑ‚Ð²Ð° ÑƒÐ¿Ñ€Ð°Ð²Ð»ÐµÐ½Ð¸Ñ Ð²Ñ‹ÑÐ¾Ñ‚Ð¾Ð¹
...
ScanVehicles()
print("[SUCCESS] UTeamz Mobile Script Loaded!")
